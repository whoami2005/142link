...
import com.krishna.amzplugin.mirror.DefaultMirroringAudioTrackResolver;
import com.krishna.amzplugin.mirror.MirroringAudioSourceManager;
import com.krishna.amzplugin.mirror.MirroringAudioTrackResolver;
...
public class AmazonMusicSourceManager extends MirroringAudioSourceManager implements AudioSearchManager {
	...
	public void setWebhook(com.krishna.amzplugin.plugin.DiscordWebhookLogger webhook) {
